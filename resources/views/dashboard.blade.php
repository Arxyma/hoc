<x-app-layout>
    ...
    <div class="container mx-auto py-4">
        <!-- Hero -->
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 my-14 mb-36">
            <!-- Grid -->
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                        Ubah idemu <span class="text-orange-400">jadi solusi!</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Pemecahan masalah interaktif yang
                        menyenangkan dan efektif. Wujudkan ide menjadi solusi dalam komunitas setiap hari.</p>
        ...
        <div class="grid-flow-row my-14">
            <!-- Card Blog -->
            <h2 class="text-5xl text-blue-500 text-center font-bold">Dirancang untuk Membangun, Bersama Komunitas</h2>
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
                    ...
                    <div class="lg:flex">
                        ...
                        <div class="flex flex-col justify-between py-6 lg:mx-6">
                            ...
                            <span class="text-sm text-white dark:text-gray-300 bg-indigo-400 rounded-md p-2">Mentor : {{ $event->mentor->name }}</span>
