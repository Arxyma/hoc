                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select id="mentor_id" name="mentor_id"
                            ...
                            @foreach ($mentor as $mentor)
                                <option value="{{ $mentor->id }}" @selected($mentor->id === $event->mentor_id)>{{ $mentor->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('mentor_id')
                    ...
                    <div>
                        ...
                        <select id="tag" name="tag"
                            ...
                            <option value="awareness" {{ old('tag', $event->tag) == 'awareness' ? 'selected' : '' }}>
                                Awareness</option>
                            <option value="pra inkubasi"
                                {{ old('tag', $event->tag) == 'pra inkubasi' ? 'selected' : '' }}>Pra Inkubasi
                            </option>
                            <option value="inkubasi" {{ old('tag', $event->tag) == 'inkubasi' ? 'selected' : '' }}>
                                Inkubasi</option>
                            <option value="pasca inkubasi"
                                {{ old('tag', $event->tag) == 'pasca inkubasi' ? 'selected' : '' }}>Pasca Inkubasi
                            </option>
                        </select>
                        @error('tag')
                            <div class="text-sm text-red-400">{{ $message }}</div>
