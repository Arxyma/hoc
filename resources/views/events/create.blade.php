<x-app-layout>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select id="tag" name="tag"
                            ...
                            <option value="awareness" {{ old('tag') == 'awareness' ? 'selected' : '' }}>Awareness
                            </option>
                            <option value="pra inkubasi" {{ old('tag') == 'pra inkubasi' ? 'selected' : '' }}>Pra
                                Inkubasi</option>
                            <option value="inkubasi" {{ old('tag') == 'inkubasi' ? 'selected' : '' }}>Inkubasi</option>
                            <option value="pasca inkubasi" {{ old('tag') == 'pasca inkubasi' ? 'selected' : '' }}>Pasca
                                Inkubasi</option>
                        </select>
                        @error('tag')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Tulis deskripsi disini...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            HSSelect.init(document.getElementById('mentor_ids'));
        });
    </script>
