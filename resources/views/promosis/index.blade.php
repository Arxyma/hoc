                    ...
                    <div>
                        ...
                        <div class="text-gray-600 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 24 24"
                                fill="currentColor">
                                <path
                                    d="M12 2a5 5 0 100 10 5 5 0 000-10zM4 18a8 8 0 0116 0v1a1 1 0 01-1 1H5a1 1 0 01-1-1v-1z" />
                            </svg>
                        ...
                        <div class="text-gray-500 text-sm flex items-center mt-1">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 24 24"
                                fill="currentColor">
                                <path
                                    d="M8 2a1 1 0 00-1 1v1H5a3 3 0 00-3 3v12a3 3 0 003 3h14a3 3 0 003-3V7a3 3 0 00-3-3h-2V3a1 1 0 10-2 0v1H9V3a1 1 0 00-1-1zM4 10h16v9a1 1 0 01-1 1H5a1 1 0 01-1-1v-9z" />
                            </svg>
                        ...
                        @can('admin')
                            <td class="border px-4 py-2">
                                <form action="{{ route('promosis.edit', $promosi->id) }}" method="GET"
                                    class="inline-block">
