<x-app-layout>
            ...
            @else
                <div>
                    <p class="text-center pt-5">
                        Untuk mempromosikan produk Anda, Anda harus bergabung dalam <b>Event Inkubasi</b> yang kami adakan untuk para pelaku usaha agar mendapatkan eksposur lebih luas dan menjangkau target pasar yang tepat. Jika Anda membutuhkan informasi lebih lanjut atau memiliki pertanyaan, jangan ragu untuk menghubungi admin kami melalui kontak yang tersedia. Bersama kami, jadikan produk Anda lebih dikenal!                    
                    </p>
                    <div class="flex justify-center mt-6">
    ...
    <section class="max-w-screen-xl mx-auto px-6 mt-20">
         <!-- Form Pencarian -->
        <section class="max-w-screen-xl mx-auto px-6 mt-6 w-30">
